  ...
  return (
    <section id="included" className="section-animate py-12 md:py-20">
      <div className="container-landing">
        ...
        {/* порядок доступа: без этой строки кажется, что роботов продают вместо обучения */}
        <p className="mt-6 text-sm md:text-base text-muted-foreground max-w-3xl">
          Сначала школа и правило, потом инструменты: Echo Gate, Hunter Bot и Risk Sentinel
          открываются выпускникам по подписке.
        </p>
      </div>
    </section>
  );
