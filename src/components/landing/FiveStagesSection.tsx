...
const STAGES = [
  {
    n: '01',
    title: 'Теория',
    text: 'На самостоятельном курсе теория идёт 10 главами. Со мной та же база пересобрана плотнее, в 8 блоков: часть глав объединена, чтобы быстрее дойти до практики. Блок за блоком, на блок сутки, при необходимости двое. После каждого блока домашнее задание: проверяю лично и поправляю, пока не станет понятно.',
  },
  {
    n: '02',
