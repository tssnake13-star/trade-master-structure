      ...
      <div className="container-landing">
        <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-12 lg:gap-16">
          ...
          <div className="flex-1 max-w-2xl order-2 lg:order-1">
            ...
            {/* Pain anchor - hidden on mobile for compactness */}
            <div className="hidden md:block mt-6 lg:mt-8 text-lg md:text-xl leading-relaxed fade-in-up fade-in-up-delay-1 space-y-4 lg:space-y-6">
              <p className="text-muted-foreground">
                Вы садитесь за терминал с мыслью «сейчас аккуратно». Через время ловите себя на том, что уже в позиции без чёткого плана. А потом снова прокручиваете в голове: зачем я туда вошёл?
              </p>
              <p className="text-muted-foreground/70">
                Когда нет сценария, торговля превращается в напряжение. Сомнения до входа, дергание в позиции и усталость не от рынка, а от собственных решений.
              </p>
              <p className="text-muted-foreground/70">
                Вы входите не потому, что видите возможность, а потому что страшно упустить или хочется наконец «сделать правильно».
              </p>
            </div>
            ...
            <p className="mt-4 md:mt-8 lg:mt-10 text-base md:text-lg lg:text-xl text-foreground/90 font-medium fade-in-up fade-in-up-delay-1">
              С вами всё нормально. Ненормально принимать решения без структуры.
            </p>
            ...
            <div className="mt-6 md:mt-10 lg:mt-14 fade-in-up fade-in-up-delay-2">
              <p className="hidden md:block mb-3 text-sm text-muted-foreground/70">
                Здесь разбирается не рынок, а логика решений. Как перестать торговать из тревоги и начать действовать по сценарию.
              </p>
              ...
              <p className="mt-2 md:mt-3 text-xs md:text-sm text-muted-foreground">
                Разборы сделок, логика решений и путь к спокойной торговле.
              </p>
            </div>
          </div>
