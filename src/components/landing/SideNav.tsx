...
const sections = [
  ...
  { id: 'included', num: '02', label: 'Что входит' },
  { id: 'trading-system', num: '03', label: 'Архитектура' },
  { id: 'protection', num: '04', label: 'Защита' },
  { id: 'stats', num: '05', label: 'Результаты' },
  { id: 'proof', num: '06', label: 'Отзывы' },
  { id: 'trades', num: '07', label: 'Сделки' },
