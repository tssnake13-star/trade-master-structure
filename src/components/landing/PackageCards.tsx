...
const PACKAGES: Pkg[] = [
  ...
  },
  {
    ...
    forWhom: 'Система зарабатывает на редких крупных сделках. Пропустите их, останутся одни стопы. Шестьдесят дней я работаю с тем, что заставляет вас пропускать.',
    points: [
      'Всё из Trade System',
