...
const notFitItems = [
  'Ищете быстрые решения и лёгкие деньги',
  'Хотите готовые сигналы',
  'Не готовы к строгим правилам и дисциплине',
  'Верите в «волшебную стратегию»',
  'Не готовы пропускать большинство сделок',
];
    ...
    <section id="filter" className="section-animate py-12 md:py-20 bg-card/50">
      <div className="container-landing">
        <div className="max-w-4xl">
          <span className="section-label">10 · Фильтр</span>
