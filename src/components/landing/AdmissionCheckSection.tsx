 ...
 * Лид присылает сделку в бота → Сергей отвечает лично: голосовым, а если
 * случай требует объяснений — видеоразбором. Видео обещать нельзя.
...
const STEPS = [
  'Присылаете в бот одну свою сделку: ту, где всё сделали правильно, а убыток всё равно случился. Скрин с компьютера, где виден вход и стоп, и пара фраз, почему вошли.',
  'Я лично прогоняю её через свою систему допуска.',
  'В течение 48 часов отвечаю голосовым: сказала бы система «да» или «нет» и на чём сломалось решение. Случай требует объяснений — записываю видеоразбор.',
];
      ...
      <div className="container-landing">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-base md:text-lg text-muted-foreground" style={{ maxWidth: '56ch' }}>
            Личный разбор от практикующего трейдера, ответ в течение 48 часов. Бесплатно. Без обязательств.
          </p>
        </div>
        ...
        {/* условия отбора: без них приходят скрины с телефона и чужие рынки.
            5 — реальное число разборов, которое Сергей успевает за неделю. */}
        <p className="mt-6 text-sm text-muted-foreground" style={{ maxWidth: '62ch' }}>
          Разбираю валютные пары, золото и металлы, нефть, биткоин и эфир. Другую крипту
          не смотрю. Скрины с телефона и сделки без описания не разбираю.
        </p>
        ...
        <p className="mt-2 text-sm text-muted-foreground" style={{ maxWidth: '56ch' }}>
          Каждый разбор делаю сам, поэтому беру 5 разборов в неделю.
        </p>
