...
const faq = [
  ...
  },
  {
    ...
    a: 'Да. Первая глава — вводная: пройдите её и решите. Если после первого занятия поймёте, что вам не подходит, — вернём деньги за обучение полностью. Если идёте дальше — значит, всё устраивает, и возврат уже не делается: это цифровой продукт, который остаётся у вас. Оплата за инструменты (роботы и индикаторы) возврату не подлежит: они лицензируются под номер вашего торгового счёта, и отозвать доступ после выдачи технически невозможно.',
  },
  {
