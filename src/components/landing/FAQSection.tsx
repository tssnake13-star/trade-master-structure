...
/**
 * FAQSection — «14 · Вопросы». Первыми стоят два вопроса-фильтра из «ПОРТРЕТ КЛИЕНТА.md»
 * (совмещение с работой и интрадей) — до них доходит каждый седьмой, но это последний шанс
 * отсеять чужих до лички. Дальше — снятие последних сомнений перед финальным CTA:
...
const faq = [
  {
    ...
    a: 'Да. Рабочие таймфреймы — неделя, день и H4. Раз в неделю, на выходных, — 30–60 минут на разбор рынка и отбор инструментов, от которых ждать точку входа. В течение недели — короткая проверка триггера каждые 4 часа. Выпускникам с подпиской на экосистему триггеры присылает бот.',
  },
  {
    q: 'Я торгую внутри дня. Мне подойдёт?',
    a: 'Скорее всего, нет, и лучше выяснить это сейчас. Здесь свинг: сделка живёт днями, у экрана сидеть не нужно, но и адреналина нет. Если вам нравится движение внутри дня, со мной будет скучно и чуждо.',
  },
  {
  ...
  },
  {
    ...
    a: 'Честный ответ: если правила соблюдать вы не готовы — не получится, поэтому мы и берём не всех (см. блок «Для кого»). Система снимает эмоции с решений: допуск отвечает «да» или «нет», Risk Sentinel блокирует торговлю при −4% за неделю или −8% за месяц. Ваша часть работы — следовать правилам.',
  },
  {
    ...
    <section id="faq" className="section-animate py-12 md:py-20 bg-card/50 border-y border-border">
      <div className="container-landing">
        <div className="max-w-3xl">
          <span className="section-label">14 · Вопросы</span>
