...
const faq = [
  {
    ...
    a: 'Риск в системе фиксированный — 0.25–0.3% на сделку. Чтобы соблюдать его минимальным лотом 0.01, депозит нужен примерно от $1 000 — с этой суммы можно пробовать. Для серьёзной работы разумный минимум — $5 000–10 000. «Разогнать сотню долларов» система не предлагает — это противоречит самому принципу допуска.',
  },
  {
