        ...
        <div className="mt-10 md:mt-14 relative grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="mt-6 text-base md:text-lg text-muted-foreground">
              Для тех, кто торгует, но теряет на решениях. Перестраиваем мышление от угадывания к алгоритму. Четыре уровня — от самостоятельного курса до полной инфраструктуры.
            </p>
            <div
