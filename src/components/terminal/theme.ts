...
/** Время из бота вида «22.09.2026 04:45» — бот пишет его по ЧАСАМ VPS. Замер 22.09.2026:
 *  часы VPS — UTC+3 (кэш скринера «04:45» в файле, сохранённом в 06:45 по UTC+5), а не UTC+5,
 *  как считалось 21.09 — из-за этого время скринера на экране отставало на 2 часа. С новым
 *  мостом приходит поле `at` с поясом (его и берите); это — запасной разбор старой строки. */
