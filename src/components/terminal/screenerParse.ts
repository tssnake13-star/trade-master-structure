...
// 23.09.2026, его слово: у индекса доллара «поводырь», и у других тоже «поводырь» — «чтобы
// отделять его от других, напиши поводырь альфа… самый главный поводырь для долларовой пары.
// Все остальные просто поводыри в своей группе». Код индекса в мосте — DXY.
export const ALPHA = 'поводырь альфа';
