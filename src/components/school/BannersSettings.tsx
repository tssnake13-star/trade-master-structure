      ...
      <div className="rounded-lg border p-4 space-y-5 mb-6" style={{ borderColor: '#1a1a1a', backgroundColor: '#0d0d0d' }}>
        ...
        <div className="space-y-3">
          ...
          <p className="text-[11px] leading-relaxed" style={hintStyle}>
            {started
              ? 'Дата прошла. Ученики видят: «Следующий поток практикума уже скоро» — без даты, мест и счётчика. Поставьте дату следующего потока, когда он будет назначен.'
              : taken >= threshold
          ...
          <p className="text-[11px] leading-relaxed" style={hintStyle}>
            После даты старта баннер переходит в режим «скоро»: дата, места и счётчик убираются сами. Новый отсчёт запускается только здесь, руками, когда следующий поток назначен.
          </p>
