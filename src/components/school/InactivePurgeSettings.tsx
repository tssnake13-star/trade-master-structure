 ...
 *
 * Пока тариф горит, доступ лежит в course_access и аккаунт не трогается.
 * После окончания тарифа человек становится обычным бесплатником, и отсчёт
 * идёт от ДАТЫ ОКОНЧАНИЯ (profiles.paid_until), а не только от последнего
 * входа: иначе тот, кто не заходил весь оплаченный срок, удалился бы на
    ...
    <>
      ...
      <div className="rounded-lg border p-4 space-y-4 mb-6" style={{ borderColor: '#1a1a1a', backgroundColor: '#0d0d0d' }}>
        ...
        <p className="text-[11px] leading-relaxed" style={{ color: '#666', fontFamily: font.mono }}>
          Чистка идёт ночью, раз в сутки. Пока тариф действует, аккаунт не трогается. После
          окончания тарифа срок считается заново, от даты окончания. Админы не удаляются никогда.
          Удаление необратимо: уходят профиль, прогресс и учётная запись.
        </p>
