  ...
  return (
    <div data-school-skin className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: '#080808' }}>
      <div className="w-full max-w-md">
        <h1 className="text-3xl mb-8 text-center" style={{ fontFamily: "'Hanken Grotesk', sans-serif", color: '#e8e0d0' }}>
          Новый пароль
        </h1>
        <form onSubmit={handleReset} className="space-y-4">
          <input
            ...
            style={{ backgroundColor: '#111', borderColor: '#222', color: '#e8e0d0', fontFamily: "'Hanken Grotesk', sans-serif" }}
          />
          ...
          <button
            ...
            style={{ backgroundColor: '#4a8a4a', color: '#e8e0d0', fontFamily: "'Hanken Grotesk', sans-serif", opacity: loading ? 0.6 : 1 }}
          >
