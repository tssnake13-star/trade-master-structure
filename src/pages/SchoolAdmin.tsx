...
function StudentsTab() {
  ...
  const paidFreshness = (uid: string) => {
...
function AccessTab() {
  ...
  return (
    <div>
      <h2 className="text-lg mb-4" style={{ fontFamily: font.heading }}>
        Доступы
        <span className="text-xs ml-2" style={{ fontFamily: font.mono, color: '#555' }}>
          {accesses.length} активных
        </span>
      </h2>
